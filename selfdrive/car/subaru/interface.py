...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    if candidate == CAR.IMPREZA:
      ...
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.01, 0.035, 0.15], [0.001, 0.035, 0.04]]
      #ret.lateralTuning.pid.kf = 0.00007843996051470903
      #ret.lateralTuning.pid.newKfTuned = True
      #ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kpBP = [[0., 14., 23.], [0., 14., 23.]]
      #ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.000125, 0.0004375, 0.001875], [0.000005, 0.00075, 0.000125]]
